...
public class Science300 extends JFrame {

	private JPanel contentPane;
	private JTextField textField;
static int point=300;
	...
	public  Science300() {
		...
		JLabel lblNewLabel = new JLabel("What is the magnitude of the gravitational acceleration on surface of earth?");
		lblNewLabel.setFont(new Font("Tahoma", Font.PLAIN, 12));
		lblNewLabel.setBounds(12, 13, 420, 39);
			...
			String s;
				  ...
				  if(counter==1) {
					 ...
					 Attemp1.score=Attemp1.score+point;
					  ...
					  System.out.println("You earned 300 points");
