...
public class Computer200 extends JFrame {

	private JPanel contentPane;
	private JTextField textField;
static int point=200;
	...
	public  Computer200() {
		...
		JLabel lblNewLabel = new JLabel("When was the first programmable computer  invented?");
		...
		//Checks if the anwser is correct or not 
